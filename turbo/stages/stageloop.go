...
func NewDefaultStages(ctx context.Context,
	...
	zkSynchronizer stagedsync.ZkSynchronizer,
) []*stagedsync.Stage {
	dirs := cfg.Dirs
	...
	return stagedsync.DefaultStages(ctx,
		...
		// TODO [zkevm] - max - turn back on stateroot checks
		stagedsync.StageTrieCfg(db, false, true, false, dirs.Tmp, blockReader, controlServer.Hd, cfg.HistoryV3, agg),
