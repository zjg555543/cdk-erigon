...
require (
	github.com/ledgerwatch/erigon-lib v0.0.0-20220918103843-f05cd214bd2e
...
replace github.com/anacrolix/torrent => github.com/AskAlexSharov/torrent v1.46.1-0.20220919055449-b26351069f5d
