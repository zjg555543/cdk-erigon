...
var (
	...
	GnosisWithdrawalsDevnet4GenesisStateRoot = libcommon.HexToHash("0x2bb5d28981d37b644dc641e44a665ba98cf77a35e4a6f5f6f3adf910189c7df0")
)
...
var (
	...
	GnosisWithdrawalsDevnet4ChainConfig = readChainSpec("chainspecs/gnosis_withdrawals_devnet_4.json")
...
func ChainConfigByChainName(chain string) *chain.Config {
	...
	case networkname.GnosisWithdrawalsDevnet4Name:
		return GnosisWithdrawalsDevnet4ChainConfig
	default:
		return nil
	}
}
...
func GenesisHashByChainName(chain string) *libcommon.Hash {
	...
	case networkname.GnosisWithdrawalsDevnet4Name:
		return &GnosisWithdrawalsDevnet4GenesisHash
	default:
		return nil
	}
}
...
func ChainConfigByGenesisHash(genesisHash libcommon.Hash) *chain.Config {
	...
	case genesisHash == ChiadoGenesisHash:
		return ChiadoChainConfig
	case genesisHash == GnosisWithdrawalsDevnet4GenesisHash:
		return GnosisWithdrawalsDevnet4ChainConfig
	default:
		return nil
	}
