...
func createSentinel(cfg *sentinel2.SentinelConfig, db kv.RoDB, logger log.Logger) (*sentinel2.Sentinel, error) {
...
func StartSentinelService(cfg *sentinel2.SentinelConfig, db kv.RoDB, srvCfg *ServerConfig, creds credentials.TransportCredentials, initialStatus *cltypes.Status, logger log.Logger) (sentinelrpc.SentinelClient, error) {
