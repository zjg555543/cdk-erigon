...
// too small - causing too much requests management and random disk read/writes
// too big - causing protocol to be unresponsive (tcp/udp network multiplexing will not work well,
//      packets will not fit in network buffers and block other packets to travel through network)
// default: 16Kb
